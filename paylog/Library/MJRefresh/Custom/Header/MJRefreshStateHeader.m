...
//    [self setTitle:MJRefreshHeaderRefreshingText forState:MJRefreshStateRefreshing];
    [self setTitle:NSLocalizedString(@"refreshenter", @"") forState:MJRefreshStateIdle];
    [self setTitle:NSLocalizedString(@"refreshdown", @"") forState:MJRefreshStatePulling];
    [self setTitle:NSLocalizedString(@"refreshup", @"") forState:MJRefreshStateRefreshing];
}
